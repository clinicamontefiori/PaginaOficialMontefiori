...
<body>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
								<?php
								$searproye = lista_registros_cms('jtestimonios', 'json');
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="testimonios-add?id=<?php echo $ProSeObj->idtestimonio?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idtestimonio?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            const $link = $(this);
            const idtestimonio = $link.data("id");
            ...
            try {
                ...
                const $form = $('<form>', {
                    method: 'POST',
                    action: 'controlador/testimonios.php',
                    target: '_self'
                });
				...
				$form.append('<input type="hidden" id="idtestimonio" name="idtestimonio" value="' + idtestimonio + '">');
