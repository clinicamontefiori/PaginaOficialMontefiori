					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
								<?php
								$searproye = lista_registros_cms('jpagina', 'json');
								foreach ( $searproye as $ProSeObj ){
								?>
									<tr>
										<td><a href="../<?php echo $ProSeObj->url?>" target='_blank'><?php echo $ProSeObj->titulo?></a></td>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="pagina-add?id=<?php echo $ProSeObj->url?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idpagina?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php }  ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            try {
				...
				$form.append('<input type="hidden" id="idpagina" name="idpagina" value="' + idpagina + '">');
