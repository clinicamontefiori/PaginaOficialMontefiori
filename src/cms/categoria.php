...
<body>
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				<!--breadcrumb-->
				<?php echo imprime_breadcrumb('Categoria'); ?>
				<!--end breadcrumb-->
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jcategoria', 'json');
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="categoria-add?id=<?php echo $ProSeObj->idcategoria?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idcategoria?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            const $link = $(this);
            const idcategoria = $link.data("id");
            ...
            try {
                ...
                const $form = $('<form>', {
                    method: 'POST',
                    action: 'controlador/categoria.php',
                    target: '_self'
                });
				...
				$form.append('<input type="hidden" id="idcategoria" name="idcategoria" value="' + idcategoria + '">');
