					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jslider_general', 'json');
								foreach ( $searproye as $ProSeObj ){
								?>
									<tr>
										<td><?php echo $ProSeObj->titulo?></td>
										<td><?php echo $ProSeObj->url?></td>								
										<td><?php echo $ProSeObj->nombre_seccion?></td>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="slider-add?id=<?php echo $ProSeObj->idbanner?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idbanner?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            try {
				...
				$form.append('<input type="hidden" id="idbanner" name="idbanner" value="' + idbanner + '">');
