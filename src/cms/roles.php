					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jroles_general', 'json');
								$i = 1;
								...
								?>
									<tr>
										...
										<td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleScrollableModal<?php echo $i; ?>">[Ver]</button><?php //echo $ProSeObj->page?></td>
										<div class="modal fade" id="exampleScrollableModal<?php echo $i; ?>" tabindex="-1" aria-hidden="true">
											<div class="modal-dialog modal-dialog-scrollable">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title"><?php echo $ProSeObj->nombre?></h5>
														<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
													</div>
													<div class="modal-body" style="white-space: normal;">
														<?php echo $ProSeObj->page?>
													</div>
												</div>
											</div>
										</div>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="roles-add?id=<?php echo $ProSeObj->idrol?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idrol?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            try {
				...
				$form.append('<input type="hidden" id="idrol" name="idrol" value="' + idrol + '">');
