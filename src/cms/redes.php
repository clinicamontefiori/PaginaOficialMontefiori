					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jredes_general', 'json');
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="redes-add?id=<?php echo $ProSeObj->idrs?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idrs?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php }  ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            try {
				...
				$form.append('<input type="hidden" id="idrs" name="idrs" value="' + idrs + '">');
