	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				<!--breadcrumb-->
				<?php echo imprime_breadcrumb('Solicite Presupuesto',1); ?>
				<!--end breadcrumb-->
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$cnx = cnx();
								$data = $cnx->select('fb_solicite_presupuesto')->result_array();
								...
								?>
									<tr>
										...
										<td><a target="_blank" href="../uploads/presupuesto/<?php echo $fila['orden_medica']; ?>"><?php echo $fila['orden_medica']; ?></a></td>
										<td><a target="_blank" href="../uploads/presupuesto/<?php echo $fila['adjunta_archivo']; ?>"><?php echo $fila['adjunta_archivo']; ?></a></td>
