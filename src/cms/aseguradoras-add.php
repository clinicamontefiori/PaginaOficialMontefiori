...
if($_GET){
	...
	$searproye = detalle_registros_cms('jaseguradoras', 'json');
	$proceso ='upd';

	foreach ( $searproye as $ProSeObj ){
		if ( $ProSeObj->idaseguradora == $idpage ) {
			$idaseguradora = $ProSeObj->idaseguradora;
...
<body>
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				<!--breadcrumb-->
				<?php echo imprime_breadcrumb('Aseguradoras'); ?>
				<!--end breadcrumb-->
					...
					<div class="col-xl-6 mx-auto">
						<div class="card">
							<div class="card-header px-4 py-3">
								<h5 class="mb-0">Mantenimiento Aseguradoras</h5>
							</div>
							<div class="card-body p-4">
								<form id="jQueryValidationForm" class="row g-3 needs-validation" data-sitekey="<?php echo SITE_KEY; ?>"  action="controlador/aseguradoras.php" method="post" enctype="multipart/form-data" novalidate="">
									<div class="col-md-12">
										<input type="hidden" name="recaptcha_token" id="recaptcha_token" value="">	
										<input type="hidden" id="idaseguradora" name="idaseguradora" value="<?php echo $idaseguradora; ?>">
									...
									<div class="col-md-6">
										...
										<?php if ($imgdesktop!='') { ?>
												<a target="_blank" href="../uploads/logos/<?php echo $imgdesktop;?>">[ver IMG]</a> <a href="#" data-id='<?php echo $idaseguradora?>' data-vatipo='imgdesktop' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
										<?php } ?>
										</div>
									</div>
	...
	$(document).ready(function () {
            $('.enviarPost').click(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'controlador/aseguradoras.php', // Reemplaza con la URL de tu script PHP
                    data: { recaptcha_token: token, proceso: proceso, idaseguradora: idaseguradora },
