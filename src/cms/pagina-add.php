...
if($_GET){
	...
	$idpage = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
	$searproye = detalle_registros_cms($idpage, 'json/paginas/');


	$proceso ='upd';
	$idpagina = $searproye->idpagina;
...
<body>
	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content">
				<!--breadcrumb-->
				<?php echo imprime_breadcrumb('Pagina'); ?>
				<!--end breadcrumb-->
					...
					<div class="col-xl-6 mx-auto">
						<div class="card">
							<div class="card-header px-4 py-3">
								<h5 class="mb-0">Mantenimiento Página</h5>
							</div>
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" action="controlador/pagina.php" data-sitekey="<?php echo SITE_KEY; ?>"  method="post" enctype="multipart/form-data" novalidate="">
									<div class="col-md-12">
										<input type="hidden" name="recaptcha_token" id="recaptcha_token">
										
										<input type="hidden" id="idpagina" name="idpagina" value="<?php echo $idpagina; ?>">
									...
									<div class="col-md-12">
										...
										<textarea rows="25" id="detalle" required name="detalle"><?php echo $detalle?></textarea>
									</div>


									<div class="col-md-12">
										<label for="bsValidation13" class="form-label">URL Página</label>
									...
									<div class="col-md-6">
										...
										<?php if ($imgdesktop!='') { ?>
												<a target="_blank" href="../uploads/paginas/<?php echo $imgdesktop;?>">[ver IMG]</a> <a href="#" data-id='<?php echo $idpagina?>' data-vatipo='imgdesktop' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
										<?php } ?>
										</div>
									</div>
									...
									<div class="col-md-6">
										...
										<?php if ($imgmovil!='') { ?>
												<a target="_blank" href="../uploads/paginas/<?php echo $imgmovil;?>">[ver IMG]</a> <a href="#" data-id='<?php echo $idpagina?>' data-vatipo='imgmovil' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
										<?php } ?>
										</div>
									</div>	
	...
	$(document).ready(function () {
            $('.enviarPost').click(function (e) {
            	...
            	var idpagina = $(this).data("id");

                $.ajax({
                    type: 'POST',
                    url: 'controlador/pagina.php', // Reemplaza con la URL de tu script PHP
                    data: { recaptcha_token: token, proceso: proceso, idpagina: idpagina },
