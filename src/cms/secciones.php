...
<body>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jsecciones_general', 'json');
								foreach ( $searproye as $ProSeObj ){
								?>
									<tr>
										<td><?php echo $ProSeObj->nombre?></td>
										<td><?php echo $ProSeObj->fecharegistro?></td>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="secciones-add?id=<?php echo $ProSeObj->idseccion?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idseccion?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php }  ?>	
	...
	<!--plugins-->
	<script src="https://clinicasanfelipe.com/cms/assets/js/jquery.min.js"></script>
	<script src="https://clinicasanfelipe.com/cms/assets/plugins/simplebar/js/simplebar.min.js"></script>
	<script src="https://clinicasanfelipe.com/cms/assets/plugins/metismenu/js/metisMenu.min.js"></script>
	<script src="https://clinicasanfelipe.com/cms/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
	<script src="https://clinicasanfelipe.com/cms/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
	<script src="https://clinicasanfelipe.com/cms/assets/plugins/datatable/js/dataTables.bootstrap5.min.js"></script>
	<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            try {
                ...
                const $form = $('<form>', {
                    method: 'POST',
                    action: 'controlador/secciones.php',
                    target: '_self'
                });
				...
				$form.append('<input type="hidden" id="idseccion" name="idseccion" value="' + idseccion + '">');
