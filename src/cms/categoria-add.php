...
if($_GET){
	...
	$searproye = detalle_registros_cms('jcategoria', 'json');
	$proceso ='upd';

	foreach ( $searproye as $ProSeObj ){
		if ( $ProSeObj->idcategoria == $idpage ) {
			$idcategoria = $ProSeObj->idcategoria;
					...
					<div class="col-xl-6 mx-auto">
						<div class="card">
							<div class="card-header px-4 py-3">
								<h5 class="mb-0">Mantenimiento Categoria</h5>
							</div>
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" data-sitekey="<?php echo SITE_KEY; ?>" action="controlador/categoria.php" method="post" enctype="multipart/form-data" novalidate="">
									<div class="col-md-12">
