...
<body>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php
								$searproye = lista_registros_cms('jaseguradoras', 'json');
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="aseguradoras-add?id=<?php echo $ProSeObj->idaseguradora?>" class=""><i class='bx bxs-edit'></i></a>
												<a href="#" data-id='<?php echo $ProSeObj->idaseguradora?>' class="enviarPost ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>	
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.enviarPost', async function (e) {
            ...
            const $link = $(this);
            const idaseguradora = $link.data("id");
            ...
            try {
                ...
                const $form = $('<form>', {
                    method: 'POST',
                    action: 'controlador/aseguradoras.php',
                    target: '_self'
                });
				...
				$form.append('<input type="hidden" id="idaseguradora" name="idaseguradora" value="' + idaseguradora + '">');
