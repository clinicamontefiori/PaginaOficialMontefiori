<div class="container mx-auto md:px-4 px-7">
                <div class="text-center mb-10">
                    <h2 class="title-section font-bold">Noticias relacionadas</h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">                        
                        ...
                        <div class="item-card bg-white overflow-hidden hover:shadow-md transition-shadow duration-300 group border">
                            <div class="item-card__cover relative">
                                <a href="<?php echo HOST_VAR  ?>blog/<?php echo $rblog->url; ?>"><img src="<?php echo HOST_VAR  ?>uploads/blog/<?php echo $rblog->imgmovil; ?>" alt="<?php echo $rblog->titulo; ?>" class="aspect-img-news object-cover transform group-hover:scale-105 transition-transform duration-300"></a>
                ...
                <div class="text-center mt-16 mb-6">
                    <a href="<?php echo HOST_VAR  ?>blog" class="border border-gray-400 border-2 text-gray-700 font-semibold py-[14px] px-12 rounded-full hover:bg-gray-100 transition-colors">Ver más</a>
                </div>
            </div>