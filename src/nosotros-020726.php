    ...
    <main>
            ...
            <div class="container mx-auto md:px-4 px-7 z-10 relative">
                ...
                <div class="block-enter bg-white overflow-hidden  w-full flex flex-col md:flex-row">
                    ...
                    <div class="block-enter__cover md:w-1/2 md:h-auto">
                        <img class=" w-full h-full object-cover" src="uploads/img/Nuestra-HistoriaCMF.webp"
                    ...
                    <div class="md:w-1/2 p-8 sm:p-12 lg:p-12 flex flex-col justify-center">
                        ...
                        <div class="mb-5">
                            <p class="text-gray-600 leading-relaxed" style="color: #718096;">
                               La Clínica Montefiori nació el 6 de mayo de 1983 gracias al sueño de un grupo de
                            profesionales con amplia experiencia, que quisieron crear un espacio privado de
                            salud cercano, moderno y humano. Desde entonces, su propósito ha sido ofrecer
                            una atención integral en consulta ambulatoria, emergencias y hospitalización,
                            combinando altos estándares de calidad con un genuino compromiso por el
        ...
        <section class="bg-white py-16">
            <div class="container mx-auto md:px-4 px-7">
                <header>
                    <h2 class="title-section font-bold">Nuestra Cultura CCR</h2>
                    <p class="mt-7 text-lg">En Clínica Montefiori creemos que cuidar la salud es también cuidar el
                        corazón. Por eso vivimos nuestra cultura <span class="font-bold">CCR</span>: Cordialidad,
                        confianza y rapidez, valores que nos guían en cada paciente y su familia.</p>
                </header>
        ...
        <section class="bg-gray-site md:py-14 py-7">
            <div class="container  mx-auto md:px-4 px-7">
                <section class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    <div class="order-1">
                        <h2 class="title-section mb-6">Nuestro ADN</h2>
                        <p class="text-slate-500 text-lg leading-relaxed">Al igual que en un ADN, cada uno de estos
                            elementos es
                            indispensable y complementario. unidos, construyen una cultura sólida, coherente y viva, que
                            evoluciona con
                            propósito y dirección. Lo resumimos en una sola idea que nos inspira cada día.</p>
                    </div>
                    <div class="order-2 flex items-start gap-6">
                        ...
                        <div class="flex gap-6 md:block">
                            ...
                            <p class="text-[17px] md:text-3xl font-medium leading-snug">
                                <span class="font-bold">Cordialidad</span> que acerca, 
                                confianza que inspira y 
                                <span class="font-bold">rapidez</span> que cuida.</p>
                        </div>
                    </div>
                </section>
        ...
        <section class="bg-white md:py-20 py-8" id="convenios">
            <div class="container mx-auto md:px-4 px-7">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    <div>
                        <h2 class="title-section mb-6">Aseguradoras y Convenios</h2>
                        <div class="space-y-4 text-slate-500 text-lg leading-relaxed">
                            <p>En <b>Clínica Montefiori</b> trabajamos para que tu experiencia de atención sea siempre ágil y cercana. Por eso
                                contamos con convenios de <b>seguros locales, autoseguros y planes de descuentos corporativos</b> que te
                                permiten acceder a nuestros servicios con confianza y tranquilidad.</p>
                            <p>Te recomendamos confirmar previamente con tu aseguradora los alcances de tu cobertura, ya que esta puede
                                variar según el plan contratado.</p>
                        </div>
                    </div>
                    <div class="lg:pl-8"><img alt="Aseguradoras y Convenios" loading="lazy"
                            class="rounded-2xl  object-cover "
                            src="uploads/img/Aseg-y-Convenio-V2.webp" height="360" width="563"></div>
                </div>
            </div>
        </section>
                                    ...
                                    <li class="splide__slide">
                                         <div class="bg-[#F3F6F8] rounded-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
                                            <div class="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                                                <h2 class="title-section mb-6">Nuestro Staff Médico</h2>
                                                <p class="text-gray-500 mb-6 leading-relaxed">En Clínica Montefiori contamos con un equipo médico de más de 150
                                                    especialistas en más de 35 especialidades; reconocidos por su experiencia, calidad médica y compromiso con
                                                    la salud.</p>
                                                <p class="text-gray-500 mb-8 leading-relaxed">Cada uno brinda una atención cercana, con la confianza y la
                                                    calidez que nos distinguen. Conoce a nuestro staff y encuentra aquí al médico ideal para tu cuidado de tu
                                                    salud.</p>
                                            ...
                                            <div class="relative min-h-[300px] lg:min-h-0"><img class="absolute inset-0 h-full w-full object-cover"
                                                    alt="Un equipo de profesionales médicos"
                                                    src="uploads/img/Staff-Medicov1.webp">
                                            </div>
                                        </div>
                                    </li>
                                </ul>
